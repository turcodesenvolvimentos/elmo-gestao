...
import {
  usePontoHistory,
  useDownloadPontoFromHistory,
  useDeletePontoFromHistory,
...
export function PontoHistory() {
  ...
  // Buscar histórico de relatórios de ponto
  const { data: historyData, isLoading } = usePontoHistory({
    page: currentPage,
    page_size: pageSize,
  });

  const downloadMutation = useDownloadPontoFromHistory();
  const deleteMutation = useDeletePontoFromHistory();
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Visualize e faça download dos relatórios de ponto exportados anteriormente
            </CardDescription>
          </CardHeader>
          <CardContent>
            {isLoading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground">
                  Nenhum relatório de ponto foi exportado ainda.
                </p>
              </div>
            ) : (
              <>
                    ...
                    <TableBody>
                      {history.map((item) => (
                        <TableRow key={item.id}>
                          ...
                          <TableCell className="text-right font-mono text-sm">
                            {formatHours(item.total_normal_hours)}
                          </TableCell>
