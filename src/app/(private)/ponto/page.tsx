        ...
        <div className="flex flex-1 flex-col gap-6 p-6">
                ...
                <div className="flex-1 space-y-4 lg:space-y-0 lg:flex lg:items-center lg:gap-4">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-1">
                      <Combobox
                        ...
                        onValueChange={(value) => {
                          if (!value) {
                            setFilter((prev) => ({ ...prev, employeeId: 0 }));
                          } else {
                            const employee = employees?.content.find(e => e.name === value);
                            if (employee) {
                      ...
                      >
                        <ComboboxInput placeholder="Selecione ou digite um funcionário..." className="w-[300px]" />
                        <ComboboxContent>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex flex-col">
                      <Input
                        type="date"
                        className={`w-[140px] ${shouldSendDates && !isDateRangeValid
                          ? "border-red-500"
                          : ""
                          }`}
          ...
          <Card className="flex-1 overflow-hidden">
            <CardContent className="">
              ...
              <div className="overflow-x-auto rounded-md border text-center">
                <Table>
                  <TableHeader>
                    <tr className="bg-gray-50/50">
                      {dynamicColumns.map((item, index) => (
                        <TableHead
                          key={item}
                          className={`px-4 py-3 text-left text-center font-medium text-gray-700 whitespace-nowrap ${index < dynamicColumns.length - 1
                      ...
                      <>
                        {groupedPunches.map((group, index) => (
                          ...
                          >
                            ...
                            <TableCell
                              className={`px-4 py-3 border-r border-gray-200 ${group.isHoliday || group.dayOfWeekNumber === 0
                            ...
                            <TableCell
                              className={`px-4 py-3 border-r border-gray-200 capitalize ${group.isHoliday || group.dayOfWeekNumber === 0
                                ? "bg-blue-100 text-blue-800 font-medium"
                                : ""
                                }`}
                            >
